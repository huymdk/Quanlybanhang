...
{
    public partial class frmHoaDanBan : Form
    {
        DataTable tblCTHDB;
        public frmHoaDanBan()
        {
        ...
        private void frmHoaDanBan_Load(object sender, EventArgs e)
        {
        ...
        private void LoadInfoHoaDon()
        {
            ...
            lblBangChu.Text = "Bằng chữ: " + Functions.ChuyenSoSangChuoi(double.Parse(txtTongTien.ToString()));
        ...
        */
        private void LoadInfoHoaDon()
        {
            ...
            // Sử dụng TryParse để chuyển đổi giá trị một cách an toàn
            double tongTien;
            if (double.TryParse(txtTongTien.Text, out tongTien))
            {
                lblBangChu.Text = "Bằng chữ: " + Functions.ChuyenSoSangChuoi(tongTien);
            }
            else
            {
